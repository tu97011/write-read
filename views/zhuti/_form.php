...
<?=$form->field($model, 'class')->dropDownList(['0' => '基础训练', '1' => '写风景', '2' => '虚构写作','3' => '写人物', '4' => '科学写作', '5' => '非虚构写作','6' => '想象作文', '7' => '说明和应用', '8' => '读后感\笔记']); ?>
	...
	<?php echo $form->field($model,'zhidao')->widget('kucha\ueditor\UEditor',[
	'clientOptions' => [
        //编辑区域大小
        'initialFrameHeight' => '600',
        //设置语言
		...
		<?php echo $form->field($model,'sucai')->widget('kucha\ueditor\UEditor',[
	'clientOptions' => [
        //编辑区域大小
        'initialFrameHeight' => '600',
        //设置语言
